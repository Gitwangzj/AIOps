...
x_train = np.array(x_source_train[:120])
...
# plt.axvline(119, linestyle="dotted", linewidth=4, color='r')
...
#            loc='upper left')
# plt.savefig('netflow_prediction3.jpg')
...
plt.axvline(119, linestyle="dotted", linewidth=2, color='r')
